...
# root = "outputs"
types = ["nl_only", "src_nl", "repair_nl_only", "repair_src_nl"]
titles = ["Translation with NL-Only", "Translation with Source-NL", "Repair with NL-Only", "Repair with Source-NL"]
...
def gen_box_plot(cats_info, name, xlabel):
    data = {
        violin_info['nl_only']: [v2 for k1, v1 in cats_info[0].items() for k2, v2 in v1.items()],
        violin_info['nl_with_source']: [v2 for k1, v1 in cats_info[1].items() for k2, v2 in v1.items()],
        violin_info['repair_nl_only']: [v2 for k1, v1 in cats_info[2].items() for k2, v2 in v1.items()],
        violin_info['repair_nl_with_source']: [v2 for k1, v1 in cats_info[3].items() for k2, v2 in v1.items()]
    }
