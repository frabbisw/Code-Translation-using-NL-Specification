...
translation_generation() {
  ...
  python translation_generation_sc.py --dataset "$dataset" --source_lang "$source_lang" --target_lang "$target_lang" --filename "$filename" --model "$model" --models_dir "$model_dir"
}
